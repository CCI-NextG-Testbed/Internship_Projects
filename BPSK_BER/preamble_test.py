...
class preamble_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Preamble Test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Preamble Test")
        ...
        self._variable_qtgui_range_0_range = qtgui.Range(0, 1000, 1, 0, 200)
        ...
        self.digital_correlate_access_code_xx_ts_0 = digital.correlate_access_code_bb_ts('11010010',
          0, 'preamble')
        self.blocks_vector_source_x_1 = blocks.vector_source_b((1, 1, 0, 1, 0, 0, 1, 0), True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_b((1, 0, 1, 1, 0, 1, 0, 0), True, 1, [])
        self.blocks_stream_mux_0 = blocks.stream_mux(gr.sizeof_char*1, (8, 8))
        self.blocks_stream_demux_0 = blocks.stream_demux(gr.sizeof_char*1, (8, 8))
        self.blocks_repeat_0_0 = blocks.repeat(gr.sizeof_char*1, 32)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_char*1, 32)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, variable_qtgui_range_0)
        ...
        self.connect((self.blocks_char_to_float_0_0_0, 0), (self.qtgui_time_sink_x_1, 0))
        ...
        self.connect((self.blocks_stream_demux_0, 0), (self.blocks_char_to_float_0_0_0, 0))
        self.connect((self.blocks_stream_demux_0, 1), (self.blocks_repeat_0_0, 0))
        self.connect((self.blocks_stream_mux_0, 0), (self.digital_correlate_access_code_xx_ts_0, 0))
        ...
        self.connect((self.digital_correlate_access_code_xx_ts_0, 0), (self.blocks_stream_demux_0, 0))
