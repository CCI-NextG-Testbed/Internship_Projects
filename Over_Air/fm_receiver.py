...
class fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = qtgui.Range(87.9*10**6, 107.9*10**6, 200000, 87.9*10**6, 200)
        ...
        self._freq_2_range = qtgui.Range(0, 10000, 1, 0, 200)
        self._freq_2_win = qtgui.RangeWidget(self._freq_2_range, self.set_freq_2, "Frequency2", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_2_win)
