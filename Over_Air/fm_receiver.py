...
class fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_variable_low_pass_filter_taps_0(firdes.low_pass(1.0, self.samp_rate, 100e3, 10e3, window.WIN_HAMMING, 6.76))
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.freq, 192e3)
