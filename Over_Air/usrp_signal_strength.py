...
class usrp_signal_strength(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "USRP Signal Strength", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("USRP Signal Strength")
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_signal_strength")
        ...
        self.noise = noise = -60
        self.freq = freq = 50
        self.epsilon = epsilon = 50

        ##################################################
        # Blocks
        ##################################################

        self._noise_range = qtgui.Range(-60, 30, 1, -60, 200)
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-20, 60)
    ...
    def set_noise(self, noise):
        self.noise = noise
        self.channels_channel_model_0.set_noise_voltage((10**(self.noise/10)))
...
def main(top_block_cls=usrp_signal_strength, options=None):
