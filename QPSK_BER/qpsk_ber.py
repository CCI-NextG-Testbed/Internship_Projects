...
import qpsk_ber_epy_block_0 as epy_block_0  # embedded python block
import sip



class qpsk_ber(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK BER", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK BER")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_ber")
        ...
        self.order = order = 4
        self.sps = sps = 32
        self.qpsk_obj = qpsk_obj = digital.constellation_calcdist([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 3, 2],
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_vector_source_x_0_0 = blocks.vector_source_b(peamble, True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0, 1, 1, 2, 3, 0, 0, 1), True, 1, [])
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_char*1, delay_blk)
        ...
        self.connect((self.blocks_delay_0, 0), (self.blocks_repeat_0_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.channels_channel_model_0, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_throttle2_0_0_2, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.digital_symbol_sync_xx_0, 0))
        ...
        self.connect((self.blocks_throttle2_0_0_2, 0), (self.qtgui_freq_sink_x_0_0_0_0, 0))
        ...
        self.connect((self.root_raised_cosine_filter_0, 0), (self.blocks_throttle2_0_0_0, 0))
    ...
    def set_peamble(self, peamble):
        self.peamble = peamble
        self.blocks_vector_source_x_0_0.set_data(self.peamble, [])

    def get_variable_modulate_vector_0(self):
        return self.variable_modulate_vector_0

    def set_variable_modulate_vector_0(self, variable_modulate_vector_0):
        self.variable_modulate_vector_0 = variable_modulate_vector_0
    ...
    def set_freq_range(self, freq_range):
        ...
        self.channels_channel_model_0.set_frequency_offset((self.freq_range*10**-6))
    ...
    def set_epsilon(self, epsilon):
        ...
        self.channels_channel_model_0.set_timing_offset((1.0 + self.epsilon*10**-6))

    def get_delay_blk(self):
        return self.delay_blk

    def set_delay_blk(self, delay_blk):
        self.delay_blk = delay_blk
        self.blocks_delay_0.set_dly(int(self.delay_blk))
